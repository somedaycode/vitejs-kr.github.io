...
</code></pre></div><h2 id="transformwithesbuild" tabindex="-1"><code>transformWithEsbuild</code> <a class="header-anchor" href="#transformwithesbuild" aria-hidden="true">#</a></h2><p><strong>Type Signature:</strong></p><div class="language-ts"><pre><code><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">transformWithEsbuild</span><span class="token punctuation">(</span>
...
</code></pre></div>__VP_STATIC_END__`,23),p=[o];function c(r,l,i,u,k,d){return a(),s("div",null,p)}var f=n(e,[["render",c]]);export{h as __pageData,f as default};
